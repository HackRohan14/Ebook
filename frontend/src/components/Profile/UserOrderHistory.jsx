...
useEffect(()=>{
  ...
  return (
   <>
    {!orderHistory && <div className='flex justify-center items-center h-100%'><Loader/></div>}
          ...
          <div className='bg-zinc-800 w-full rounded py-2 px-4 flex gap-4 hover:bg-zinc-900 hover:cursor-pointer'>
            ...
            <div className='w-[16%]'>
              <h1 className='font-semibold text-green-500'>
                {items.status==="Order Placed" ?(<div className='text-yellow-500'>{items.status}</div>):items.status==="Cancelled" ? (
